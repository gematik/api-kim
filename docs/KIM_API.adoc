...
-----------------
 Method: "POST",
 "Request-URI": "https://kas.hersteller.kim.telematik/v1.0/",
...
[source]
-----------------
curl -X POST "https://kas.hersteller.kim.telematik/v1.0/" -H  "accept: application/json" -H  "Content-Type: multipart/form-data" -F "File=string"
-----------------
...
-----------------
 Method: "GET",
 "Request-URI": "https://kas.hersteller.kim.telematik/v1.0/{Ressource}",
 "HTTP-Version": "HTTP/1.1"
-----------------
...
[source]
-----------------
curl -X GET "https://kas.hersteller.kim.telematik/v1.0/{Ressource}" -H  "accept: multipart/form-data"
----------------- 
...
-----------------
 Method: "GET",
 "Request-URI": "https://kas.hersteller.kim.telematik/v1.0/MaxMailSize",
 "HTTP-Version": "HTTP/1.1"
-----------------
...
[source]
-----------------
curl -X GET "https://kas.hersteller.kim.telematik/v1.0/MaxMailSize" -H  "accept: application/json"
----------------- 
...
-----------------
 Method: "POST",
 "Request-URI": "https://account-manager.hersteller.kim.telematik/v1.0/accmgr/register/",
 "HTTP-Version": "HTTP/1.1"
-----------------
...
-----------------
 Method: "POST",
 "Request-URI": "https://account-manager.hersteller.kim.telematik/v1.0/accmgr/deregister/",
 "HTTP-Version": "HTTP/1.1"
-----------------
...
-----------------
 Method: "GET",
 "Request-URI": "https://account-manager.hersteller.kim.telematik/v1.0/accmgr/register-state/",
 "HTTP-Version": "HTTP/1.1"
...
-----------------
 Method: "PUT",
 "Request-URI": "https://account-manager.hersteller.kim.telematik/v1.0/accmgr/cm-version/",
 "HTTP-Version": "HTTP/1.1"
 "Content-Type": "application/json"
-----------------
...
-----------------
 Method: "PUT",
 "Request-URI": "https://account-manager.hersteller.kim.telematik/v1.0/accmgr/pw/",
 "HTTP-Version": "HTTP/1.1"
-----------------
