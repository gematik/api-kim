...
Die bei der optionalen Integration in das Clientsystem zu beachtenden geänderten Anforderungen sind in *[gemSpec_CM_KOMLE#2]* aufgelistet. Ein separates Clientmodul ist in diesem Fall nicht mehr notwendig.
