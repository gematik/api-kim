...
=== [FAQ] [FAQ] Vorgabe für den zu verwendenden Zeichensatz einer KIM E-Mail Adresse
...
Frage: Darf von den in [gemSpec_FD_KOMLE#KOM-LE_2184] geforderten Standardwerten abgewichen werden?
