...
Frage: Die Anforderung **"A_23165 - Verhalten bei fehlgeschlagener Integritätsprüfung"** erlaubt die Zustellung einer E-Mail trotz fehlgeschlagener Integritätsprüfung. In welcher Form soll die Zustellung erfolgen?

_Antwort: +
**KIM Clientmodul:** +
Die entschlüsselte originale Nachricht wird im Fall einer fehlgeschlagenen Integritätsprüfung als message/rfc822 MimePart in die Fehlernachricht eingebettet. +
Der Fehlertext der Fehlernachricht ist durch den nachfolgenden Text zu ergänzen: +
„`Die entschlüsselte Nachricht wurde in diese Fehlernachricht eingebettet und kann, abhängig vom verwendeten E-Mail-Client, in eigener Verantwortung eingesehen bzw. verarbeitet werden.`“_ +

_**Basis-Consumer:** +
Die entschlüsselte originale Nachricht wird im Fall einer fehlgeschlagenen Integritätsprüfung als message/rfc822 MimePart in die Fehlernachricht eingebettet. +
Der Fehlertext der Fehlernachricht ist durch den nachfolgenden Text zu ergänzen: +
„`Die entschlüsselte Nachricht wurde in diese Fehlernachricht eingebettet und kann, abhängig vom verwendeten E-Mail-Client, in eigener Verantwortung eingesehen bzw. verarbeitet werden.`“ +
...
***** Dies wird im nächsten Release entsprechend der Anforderungslage ergänzt.
