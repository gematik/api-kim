...
https://github.com/gematik/api-kim/blob/main/samples/SMIME-Profil.zip_
...
Der Empfangszeitpunkt (t2) entspricht dem Feld Arrival Date in der DSN
...
_Antwort: Um bereits zusammen mit der KOM-LE-Nachricht die Größe der originalen Client-Mail zu übermitteln wurde ein zusätzlicher X-KIM Header in der äußeren KOM-LE-Nachricht definiert. Dieser zusätzliche Header kann durch Empfangssysteme u.a. zur Lastverteilung genutzt werden. Die gematik hat dazu die folgende Anforderung in die gemSpec_CM_KOMLE aufgenommen._
...
**A_19356-* – Prüfen der Version des Empfängers** +
