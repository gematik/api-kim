...
Es ist erforderlich, dass das Primärsystem das Header Element `X-KIM-Supportadresse` befüllt. Das Header Element muss die Supportadresse des Herstellers des Primärsystems enthalten. Dadurch wird es möglich, dass Hersteller des Empfänger-Systems bei Fehlern Kontakt mit dem Hersteller des Sender-Systems aufnehmen können.
...
++++
<p align="center">
  <img width="70%" src=../images/KH_AV_Scanner.png>
</p>
++++
