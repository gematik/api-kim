...
Es ist erforderlich, dass das Primärsystem so konfigurierbar ist, dass es beim Versenden einer Nachricht eine Zustellbestätigung gemäß [RFC3461] anfordern kann. Die Übermittlung einer Zustellbestätigung erfolgt im Verlauf des SMTP Verbindungsaufbaus zum KIM Fachdienst und wird über das Kommando "NOTIFY" pro e-Mail angefordert.
