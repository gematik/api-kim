...
Die bei der Integration in das Primärsystem entfallen folgende Festlegungen beim Clientmodul sind in Kapitel 4 des Produktsteckbriefes für das Clientmodul aufgeführt. *[gemProdT_CM_KOMLE_PTV]*.
