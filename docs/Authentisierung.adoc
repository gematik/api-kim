...
== Authentifizierung
In KIM-Umfeld gibt es drei Authentisierungsmechanismen, um sich bei einem Dienst zu authentifizieren. Dazu gehören die SMTP/POP3-Authentifizierung, die HTTP-Basic-Auth und das Verwenden eines JSON-Web-Tokens. Die Details sowie Verweise auf die entsprechenden Anforderungen werden im folgenden beschrieben. 
