...
- Anforderungen für das Reporting der neuen X-KIM-Header wurden erstellt (neu CM A_23737, FD A_23746, A_23748). Für das Betriebsdatenreporting wurde ein Report erstellt.
