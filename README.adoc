...
- *hotfix/<name>* (in hotfix branches werden Hotfixes entwickelt; basiert auf develop; nach Fertigstellung erfolgt ein merge in develop und in main; wird nach dem merge gelöscht)
