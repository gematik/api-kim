...
|https://fachportal.gematik.de/downloadcenter/releases/aktuelle-releases#c5917[R3.1.3-12]
|https://fachportal.gematik.de/downloadcenter/releases/aktuelle-releases#c5917[KIM 1.5.2-1]
|===
...
link:docs/faq.adoc[- Fragen und Antworten zur aktuellen Spezifikation]
